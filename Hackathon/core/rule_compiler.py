...
class RuleCompiler:
    ...
    def _build_alias_map(self):
        ...
        # Heuristic aliases mapping to col_id dynamically based on schema
        # xmeas_7 is reactor pressure
        # xmeas_9 is reactor temp
        # xmv_10 is cooling water valve
        for orig_key, alias_list in [
            ...
            if orig_key in mapping:
                target_cid = mapping[orig_key]
                for a in alias_list:
                    mapping[a] = target_cid
